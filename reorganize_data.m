...
data_root = 'S:\_Lea\1.Data\20251007_aIC_BLA_B3\20251016_FS\FS_aIC_BLA_B3'
...
%                  fclose(fod)
                 ...
                 try
                    ...
                    ts = table2array(sig(:,1));  % extract time
                    
                    cols_to_remove = [1, 2, 5];
                    cols_to_remove(cols_to_remove > width(sig)) = [];  % only keep valid indices
                    sig(:, cols_to_remove) = [];
